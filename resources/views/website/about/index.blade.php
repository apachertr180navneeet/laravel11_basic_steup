            ...
            <div class="row">
                <div class="col-lg-8 m-auto">
                    <div class="about-banner-content text-center">
                        <h1 class="mb-15 text-white">About GSG Web Soft</h1>
                        <h5 class="font-weight--normal text-white">GSG Web Soft specializes in technological and IT-related services such as product engineering, warranty management, building cloud, infrastructure, network, etc. </h5>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-5 offset-lg-1">
                        <div class="cybersecurity-about-text">
                            <div class="text">GSG Web Soft specializes in technological and IT-related services such as product engineering, warranty management, building cloud, infrastructure, network, etc. We put a strong focus on the needs of your business to figure out solutions that best fits your demand and nail it.</div>
                                    ...
                                    <div class="image-box-wrap">
                                        <div class="box-image">
                                            <div class="default-image">
                                                <img class="img-fulid" src="{{asset('website/assets/images/icons/mitech-box-image-style-06-image-01-120x120.webp')}}" alt="">
                                            </div>
                                        </div>
                                        <div class="content">
                            ...
                            <div class="col-lg-4 col-md-6 wow move-up">
                                ...
                                <div class="ht-box-images style-06">
                                    <div class="image-box-wrap">
                                        <div class="box-image">
                                            <div class="default-image">
                                                <img class="img-fulid" src="{{asset('website/assets/images/icons/mitech-box-image-style-06-image-02-120x120.webp')}}" alt="">
                                            </div>
                                        </div>
                                        <div class="content">
                            ...
                            <div class="col-lg-4 col-md-6 wow move-up">
                                ...
                                <div class="ht-box-images style-06">
                                    <div class="image-box-wrap">
                                        <div class="box-image">
                                            <div class="default-image">
                                                <img class="img-fulid" src="{{asset('website/assets/images/icons/mitech-box-image-style-06-image-03-120x120.webp')}}" alt="">
                                            </div>
                                        </div>
                                        <div class="content">
                    ...
                    <div class="delivering-optimal-wrap">
                        ...
                        <div class="list-item">
                            ...
                            <div class="title-wrap">
                                ...
                                <div class="desc">At GSG Web Soft, we have a holistic and integrated approach towards core modernization to experience technological evolution. </div>
                            </div>
                        </div>
                        <div class="list-item">
                            <div class="marker"></div>
    ...
    <div class="contact-us-area infotechno-contact-us-bg section-space--pt_100">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-7">
                    <div class="image">
                        <img class="img-fluid" src="{{asset('website/assets/images/banners/home-cybersecurity-contact-bg-image.webp')}}" alt="">
                    </div>
                </div>
                                ...
                                <div class="content-wrap">
                                    <div class="content">
                                        ...
                                        <div class="main-content">
                                            ...
                                            <div class="text">9829507344</div>
                                        </div>
                                    </div>
                                </div>
                            </a>
                            <a href="mailto:hello@gsgwebsoft.com" class="single-contact-list">
                                <div class="content-wrap">
                                    <div class="content">
                                        <div class="icon">
                                        ...
                                        <div class="main-content">
                                            ...
                                            <div class="text">hello@gsgwebsoft.com</div>
                                        </div>
                                    </div>
                                </div>
                            </a>
